...
class UpdateTemplateRequest(BaseModel):
    """
    Request to update an existing template. All fields optional.  Note: cross-field validation (e.g. custom mode requires custom instructions) cannot be fully checked here because this is a partial update. The endpoint must merge with the existing record and validate the final state.
    """ # noqa: E501
    description: Optional[StrictStr] = None
    author: Optional[StrictStr] = None
    tags: Optional[List[StrictStr]] = None
    min_hindclaw_version: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["description", "author", "tags", "min_hindclaw_version", "min_hindsight_version", "retain_mission", "reflect_mission", "observations_mission", "retain_extraction_mode", "retain_custom_instructions", "retain_chunk_size", "retain_default_strategy", "retain_strategies", "entity_labels", "entities_allow_free_form", "enable_observations", "consolidation_llm_batch_size", "consolidation_source_facts_max_tokens", "consolidation_source_facts_max_tokens_per_observation", "disposition_skepticism", "disposition_literalism", "disposition_empathy", "directive_seeds", "mental_model_seeds"]
