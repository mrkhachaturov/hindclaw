...
class CreatePolicyAttachmentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policy_id", "principal_type", "principal_id", "priority"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePolicyAttachmentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePolicyAttachmentRequest from a dict"""
        if obj is None:
            return None
