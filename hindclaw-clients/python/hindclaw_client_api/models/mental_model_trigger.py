...
class MentalModelTrigger(BaseModel):
    ...
    tag_groups: Optional[List[MentalModelTriggerTagGroupsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tag_groups": [MentalModelTriggerTagGroupsInner.from_dict(_item) for _item in obj["tag_groups"]] if obj.get("tag_groups") is not None else None
        })
        return _obj
