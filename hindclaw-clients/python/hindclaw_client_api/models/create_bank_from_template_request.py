...
class CreateBankFromTemplateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["bank_id", "template", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBankFromTemplateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBankFromTemplateRequest from a dict"""
        if obj is None:
            return None
