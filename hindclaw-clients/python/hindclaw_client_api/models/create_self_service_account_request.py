...
class CreateSelfServiceAccountRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "display_name", "scoping_policy_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSelfServiceAccountRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSelfServiceAccountRequest from a dict"""
        if obj is None:
            return None
