...
type TagGroupOr struct {
	Or []MentalModelTriggerTagGroupsInner `json:"or"`
}
...
func NewTagGroupOr(or []MentalModelTriggerTagGroupsInner) *TagGroupOr {
	this := TagGroupOr{}
	this.Or = or
	return &this
}
...
func (o *TagGroupOr) GetOr() []MentalModelTriggerTagGroupsInner {
	if o == nil {
...
func (o *TagGroupOr) GetOrOk() ([]MentalModelTriggerTagGroupsInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.Or, true
...
func (o *TagGroupOr) SetOr(v []MentalModelTriggerTagGroupsInner) {
	o.Or = v
}
