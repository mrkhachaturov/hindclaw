...
func (o *BankTemplateMentalModel) GetTrigger() MentalModelTrigger {
...
// and a boolean to check if the value has been set.
func (o *BankTemplateMentalModel) GetTriggerOk() (*MentalModelTrigger, bool) {
	if o == nil || IsNil(o.Trigger) {
		return nil, false
	}
...
func (o *BankTemplateMentalModel) SetTrigger(v MentalModelTrigger) {
	o.Trigger = &v
}
