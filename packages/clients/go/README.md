...
```bash
go get github.com/mrkhachaturov/hindclaw/packages/clients/go
```

## Usage

```go
import hindclaw "github.com/mrkhachaturov/hindclaw/packages/clients/go"
...
```bash
cd build/hindclaw
python scripts/extract-openapi.py > packages/clients/openapi.json
