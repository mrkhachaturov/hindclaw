...
type TagGroupAnd struct {
	And []MentalModelTriggerTagGroupsInner `json:"and"`
}
...
func NewTagGroupAnd(and []MentalModelTriggerTagGroupsInner) *TagGroupAnd {
	this := TagGroupAnd{}
	this.And = and
	return &this
}
...
func (o *TagGroupAnd) GetAnd() []MentalModelTriggerTagGroupsInner {
	if o == nil {
...
func (o *TagGroupAnd) GetAndOk() ([]MentalModelTriggerTagGroupsInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.And, true
...
func (o *TagGroupAnd) SetAnd(v []MentalModelTriggerTagGroupsInner) {
	o.And = v
}
